...
namespace iiCourse.Core
{
    ...
    public class iiCoreService : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of iiCoreService and prepares its HTTP client and cookie handling.
        /// </summary>
        /// <remarks>
        /// Configures an HttpClient with a CookieContainer and HttpClientHandler (automatic redirects and cookie usage enabled),
        /// sets a default User-Agent header, and initializes the internal login status to false.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Disposes the internal HttpClient and HttpClientHandler and suppresses finalization for this instance.
        /// After calling Dispose, the service instance must not be used for further network operations.
        /// </remarks>
        public void Dispose()
        {
            _client.Dispose();
        ...
        /// <summary>
        /// Performs the multi-step CAS/WMH/zhss login flow for a user and verifies their account.
        /// </summary>
        /// <param name="username">The user's identifier (student ID) used to authenticate.</param>
        /// <param name="password">The user's password.</param>
        /// <returns>
        /// A tuple where the first element is `true` if login and verification succeeded, `false` otherwise; the second element is a human-readable status or error message.
        /// </returns>
        ...
        /// <summary>
        /// Verifies the logged-in user's identity by requesting user information from the profile endpoint and comparing the returned student ID to the provided username.
        /// </summary>
        /// <param name="username">The student ID to verify.</param>
        /// <returns>`true` if the returned student ID matches <paramref name="username"/>, `false` otherwise.</returns>
        ...
        /// Get user info
        /// <summary>
        /// Retrieves the user's profile information for the specified username and caches it for subsequent calls.
        /// </summary>
        /// <param name="username">The user identifier (student ID) to query.</param>
        /// <returns>The populated <see cref="UserInfo"/> for the username, or `null` if the information cannot be retrieved.</returns>
        ...
        /// Get card info
        /// <summary>
        /// Fetches the user's campus card balance and the last consumption time.
        /// </summary>
        /// <returns>`CardInfo` containing `LastConsumeTime` and `Balance`, or `null` if the information cannot be retrieved.</returns>
        ...
        /// Get exam scores
        /// <summary>
        /// Retrieve the current exam score data for the logged-in user.
        /// </summary>
        /// <returns>The raw JSON string containing exam score data, or `null` if retrieval fails.</returns>
        ...
        /// </summary>
        /// <summary>
        /// Retrieves the list of buildings for the specified campus.
        /// </summary>
        /// <param name="campusId">Campus identifier: "1" for East Campus, "2" for West Campus.</param>
        /// <returns>A list of BuildingInfo representing available buildings; returns an empty list if no data is available or the request fails.</returns>
        ...
        /// <summary>
        /// Retrieves available spare classrooms for the specified building across predefined time slots.
        /// </summary>
        /// <param name="buildingId">Identifier of the building to query.</param>
        /// <returns>A list of SpareClassroom entries found for the building; empty if none or if an error occurs.</returns>
        ...
        /// Get class info
        /// <summary>
        /// Retrieve the current user's class schedule for the current week.
        /// </summary>
        /// <returns>A list of ClassInfo entries representing the user's scheduled classes for the week; an empty list is returned on unexpected errors.</returns>
        /// <exception cref="InvalidOperationException">Thrown when the server returns an HTML page (likely indicating the user is not logged in or the session expired), when class details cannot be retrieved, or when the system is currently in a holiday period and no class information is available.</exception>
        ...
        /// <summary>
        /// Gets the string value of a JSON property or an empty string if the property is missing or null.
        /// </summary>
        /// <param name="item">The JSON token to read the property from.</param>
        /// <param name="propertyName">The name of the property to retrieve.</param>
        /// <returns>The property's string value, or an empty string if the property is null or not present.</returns>
        ...
        /// <summary>
        /// Retrieve the list of available school years from the remote service.
        /// </summary>
        /// <returns>A list of SchoolYearInfo objects; returns an empty list if the service response is invalid or an error occurs.</returns>
        ...
        /// <summary>
        /// Retrieves the current user's class entries for the specified school year, semester, and learning week.
        /// </summary>
        /// <param name="schoolYear">The academic year to query (e.g., "2023-2024").</param>
        /// <param name="semester">The semester identifier to query (for example "1" or "2").</param>
        /// <param name="learnWeek">The learning week identifier to query.</param>
        /// <returns>A list of UserClassInfo objects representing the user's classes; returns an empty list if no data is available or an error occurs.</returns>
        ...
        /// Get week date info
        /// <summary>
        /// Retrieve the calendar dates for a specific learning week.
        /// </summary>
        /// <param name="schoolYear">Academic year identifier (for example, "2024-2025").</param>
        /// <param name="semester">Semester identifier (for example, "1" or "2").</param>
        /// <param name="learnWeek">Learning week identifier or index to query.</param>
        /// <returns>A WeekDateInfo containing Date1 through Date7 for the requested week, or `null` if the server response is invalid or an error occurs.</returns>
        ...
        /// <summary>
        /// Retrieves class schedule entries for the specified school year, semester, and learn week using the provided user class list.
        /// </summary>
        /// <param name="schoolYear">The academic year to query (e.g., "2024-2025").</param>
        /// <param name="semester">The semester identifier to query (e.g., "1" or "2").</param>
        /// <param name="learnWeek">The learning week number to query.</param>
        /// <param name="classList">A list of user classes to filter or include in the time-based query.</param>
        /// <returns>
        /// A list of SelectedTimeClassInfo objects representing classes matching the requested time parameters; returns an empty list if the server response is invalid or an error occurs.
        /// </returns>
        ...
        /// <summary>
        /// Executes a custom schedule query using the provided school year, semester, and learn week and returns matching classes and week dates.
        /// </summary>
        /// <param name="parameters">Query parameters containing SchoolYear, Semester, and LearnWeek used to perform the custom schedule lookup.</param>
        /// <returns>
        /// A tuple where:
        /// - `classes` is the list of matching SelectedTimeClassInfo entries,
        /// - `dates` is the WeekDateInfo for the queried learn week or `null` if unavailable,
        /// - `message` is a human-readable status summarizing the result or an error message on failure.
        /// </returns>
        ...
        /// <summary>
        /// Fetches the list of student evaluation tasks available to the current user from the remote review page.
        /// </summary>
        /// <returns>An ApiResponse containing the list of StudentReview items: Code = 200 and Data holds the discovered reviews on success; Code = 500 and Message contains an error description if retrieval or parsing fails.</returns>
        ...
        /// <summary>
        /// Retrieves detailed student review entries for the first available review and returns them as a list.
        /// </summary>
        /// <returns>An ApiResponse whose Data is the list of StudentReviewDetail when successful (Code = 200); Code = 404 with Message "No review data" if no reviews are found; Code = 500 with an error message on failure.</returns>
        ...
        /// <summary>
        /// Attempts to submit all pending student reviews and returns the teachers whose reviews were completed.
        /// </summary>
        /// <returns>
        /// An ApiResponse whose Data is a list of teacher names whose reviews were submitted.
        /// The response Code is 200 when submissions were performed, 404 if there were no reviews to complete, and 500 on failure.
        /// </returns>
        ...
        /// <summary>
        /// Submits the student review form found at the specified review page URL.
        /// </summary>
        /// <param name="url">The URL of the student review page containing the form to submit.</param>
